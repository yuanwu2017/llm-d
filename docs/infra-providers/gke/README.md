...
| Path | GPU | TPU |
| --- | --- | --- |
| [Inference Scheduling](../../../guides/inference-scheduling/README.md) | Large models (13B+) with Hopper or newer (A3 or newer)<br>Small or highly quantized models (1-7B) with Ampere, L4, or newer (A2, G2, or newer) | v5e, v6e, 7x|
