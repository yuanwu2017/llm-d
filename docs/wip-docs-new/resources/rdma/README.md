...
- [P/D Disaggregation Well-Lit Path](../../guides/pd-disaggregation.md) — deployment patterns using NIXL
- [Wide Expert-Parallelism Well-Lit Path](../../guides/wide-expert-parallelism.md) — multi-node deployment with DeepEP networking
