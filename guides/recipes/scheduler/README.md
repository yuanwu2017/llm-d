...
Use this when you **do not** want to deploy a proxy via Kubernetes Gateway APIs. The standalone chart deploys the scheduler EPP with an Envoy sidecar to proxy the traffic directly.
